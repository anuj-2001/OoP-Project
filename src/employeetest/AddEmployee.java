...
public class AddEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add a new Employee by adding the details below :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField4.getText().isEmpty()){
            ...
            int staffNumber = Integer.parseInt(jTextField4.getText().trim()) ;
            Employee employees = new Employee(name,surname,staffNumber,job);
